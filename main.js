...
// Define distinct names for Dev vs Prod
if (!app.isPackaged) {
    // DEV MODE: Use a separate folder to avoid messing up real data
    const devUserDataPath = path.join(app.getPath('appData'), 'swarna-pms-dev');
    app.setPath('userData', devUserDataPath);
    console.log("🚧 RUNNING IN DEV MODE. Data Path:", devUserDataPath);
} else {
    console.log("🚀 RUNNING IN PROD MODE. Data Path:", app.getPath('userData'));
}
...
function createWindow() {
  ...
  if (!app.isPackaged) {
    ...
    mainWindow.webContents.openDevTools(); // Help debugging
  } else {
